...
BOT_TOKEN = environ.get('BOT_TOKEN', "6918361600:AAG8LleDO5hMIGxYR7oBGYRiHKH9x7PC_SY")
...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/001e2730fda71c238e04a.jpg")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+X3uoMkIHhco1YTY1')
...
MSG_ALRT = environ.get('MSG_ALRT', 'AV')
...
URL = "https://raspy-eleen-jisshu11.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://raspy-eleen-jisshu11.koyeb.app/".format(FQDN, PORT)
